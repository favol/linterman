...
export const LintConfigSchema = z.object({
    ...
    custom_templates: z.record(z.string(), z.string()).optional(),
});
// ============================================================================
// Severity
// ============================================================================
...
LintConfigSchema as ConfigSchema, LintIssueSchema as IssueSchema, LintResultSchema as ResultSchema, LintStatsSchema as StatsSchema, RuleMetadataSchema as RuleSchema, };
